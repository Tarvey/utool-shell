...
while 1:
    ...
    def dend():
        if loggedin == True:
            print("DEND v1\nLOGGED IN AS " + imdumb3 + ":utool")
            print("Starting session")
            s(1); print("dend*start"); s(0.25)
            dendconf = input("you cannot exit this afterwards, do you want to continue? (y-n):")
    if inputthing == "dend":
        dend()
    def gui():
        print(f" [----------------------------------]\n",
